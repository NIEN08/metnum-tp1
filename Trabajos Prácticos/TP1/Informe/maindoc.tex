...
%basofia para el enunciado, borrar luego
...
%\date{}
%\title{Tipos abstractos de datos bÃ¡sicos}

\titulo{Trabajo Práctico I}
\fecha{10 / 04 / 2015}
\materia{M\'etodos Num\'ericos}
\grupo{Aplicaci\'on de metodos b\'asicos de Aritmetica de Palitos$^1$ para la resoluci\'on de sistemas de ecuaciones lineales.}
\integrante{Abdala, Leila}{950/12}{abdalaleila@gmail.com}
\integrante{Albertini, Alejandro}{}{ale.dc@hotmail.com}
\integrante{Bayardo, Julian}{}{julian@bayardo.com.ar}
