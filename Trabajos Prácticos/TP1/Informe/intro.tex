...
\footnotetext[5]{La demostraci\'on de esta propiedad excede los objetivos de este informe, por lo cual se asume como un resultado valido. Sin embargo, 
presentamos una idea intuitiva del motivo de esta propiedad en la secci\'on Desarrollo.
Para mas detalles sobre la demostraci\'on formal de esta propiedad, consulte a su docente amigo del laboratorio de la materia Metodos Numericos.}
...
%La demostraci\'on se describe en el Ap\'endice C. 
